...
class ArrayJobItem(BaseModel):
    """
    ArrayJobItem
    """
    tags: Optional[List[StrictStr]] = None
    payload: Union[str, Any] = Field(description="Arbitrary Json data, conforming to a schema associated with the application definition")
    __properties: ClassVar[List[str]] = ["tags", "payload"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ArrayJobItem from a JSON string"""
    ...
    def from_dict(cls, obj: dict) -> Self:
        """Create an instance of ArrayJobItem from a dict"""
        if obj is None:
            return None
