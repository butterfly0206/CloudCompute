...
from jmclient import rest
from jmclient.configuration import Configuration
from jmclient.exceptions import ApiTypeError, ApiValueError, ApiException
from jmclient.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AdminsApi()
        api_instance.healthcheck_get  # this is an instance of the class Endpoint
        api_instance.healthcheck_get()  # this invokes api_instance.healthcheck_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.healthcheck_get.callable or self.callable in this class
