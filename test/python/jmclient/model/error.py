...
class Error(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'request_context': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
    ...
    attribute_map = {
        ...
        'request_context': 'requestContext',  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, code, description, message, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            request_context ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): [optional]  # noqa: E501
