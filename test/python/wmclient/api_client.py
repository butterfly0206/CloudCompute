...
from wmclient import rest
from wmclient.configuration import Configuration
from wmclient.exceptions import ApiTypeError, ApiValueError, ApiException
from wmclient.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.acquire_token  # this is an instance of the class Endpoint
        api_instance.acquire_token()  # this invokes api_instance.acquire_token.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.acquire_token.callable or self.callable in this class
