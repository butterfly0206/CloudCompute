...
class Status(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["CREATED", "QUEUED", "SCHEDULED", "INPROGRESS", "COMPLETED", "CANCELED", "FAILED", "UNKNOWN", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["CREATED", "QUEUED", "SCHEDULED", "INPROGRESS", "COMPLETED", "CANCELED", "FAILED", "UNKNOWN", ]  # noqa: E501
