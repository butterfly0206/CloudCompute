...
class SearchResult(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, jobs, last_update_time, next_token, *args, **kwargs):  # noqa: E501
        """SearchResult - a model defined in OpenAPI

        Args:
            jobs ([Job]):
            last_update_time (str): Time from the last database update. Use it as the \"fromTime\" in the next search. Expressed in milliseconds since midnight January 1, 1970. 
            next_token (str): Internal token used for search pagination, returned in search results for queries which span multiple pages 
