...
class ArrayJobItem(ModelNormal):
    ...
    def __init__(self, payload, *args, **kwargs):  # noqa: E501
        """ArrayJobItem - a model defined in OpenAPI

        Args:
            payload ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Arbitrary Json data, conforming to a schema associated with the application definition
