...
def lazy_import():
    ...
    globals()['JobArgsAllOf'] = JobArgsAllOf
    globals()['Worker'] = Worker


class JobArgs(ModelComposed):
    ...
    def __init__(self, service, worker, *args, **kwargs):  # noqa: E501
        """JobArgs - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            idempotency_id (str): Calls with the same idempoyencyId are idempotent; if job with the same idempotencyId exists, the second job will be rejected.. [optional]  # noqa: E501
            user_type (str): One of the user types defined in jobConcurrencyLimits part of ComputeSpecification. [optional]  # noqa: E501
        """
