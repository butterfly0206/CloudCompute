...
class HealthCheckResponse(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, overall, scan_time, *args, **kwargs):  # noqa: E501
        """HealthCheckResponse - a model defined in OpenAPI

        Args:
            overall (str): The overall health of the compute service (worker manager or job manager)
            scan_time (str): The ISO8601 timestamp representing the start of the healthcheck
        ...
        Keyword Args:
            ...
            revision (str): Current build version\\. [optional]  # noqa: E501
        """
