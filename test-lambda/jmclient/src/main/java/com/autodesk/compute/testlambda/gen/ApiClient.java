...
import com.autodesk.compute.testlambda.gen.auth.ApiKeyAuth;
import com.autodesk.compute.testlambda.gen.auth.Authentication;
import com.autodesk.compute.testlambda.gen.auth.HttpBasicAuth;
import okhttp3.*;
...
public class ApiClient {
    ...
    private String basePath = "https://job-manager.fpccomp-c-uw2.cosv2-c-uw2.autodesk.com/api/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("WorkerSecurity", new HttpBasicAuth());
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://job-manager.fpccomp-c-uw2.cosv2-c-uw2.autodesk.com/api/v1
     ...
     */
    public Call buildCall(final String path, final String method, final List<Pair> queryParams, final List<Pair> collectionQueryParams, final Object body, final Map<String, String> headerParams, final Map<String, String> cookieParams, final Map<String, Object> formParams, final String[] authNames, final ApiCallback callback) throws ApiException {
        final Request request = buildRequest(path, method, queryParams, collectionQueryParams, body, headerParams, cookieParams, formParams, authNames, callback);
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public Request buildRequest(final String path, final String method, final List<Pair> queryParams, final List<Pair> collectionQueryParams, final Object body, final Map<String, String> headerParams, final Map<String, String> cookieParams, final Map<String, Object> formParams, final String[] authNames, final ApiCallback callback) throws ApiException {
     ...
     * @param reqBuilder Request.Builder
     */
    public void processCookieParams(final Map<String, String> cookieParams, final Request.Builder reqBuilder) {
     ...
     */
    public void updateParamsForAuth(final String[] authNames, final List<Pair> queryParams, final Map<String, String> headerParams, final Map<String, String> cookieParams) {
